...
async function initDictionary() {
    try {
        ...
        console.log('数据库连接成功');
        // 清除现有数据
        await Dictionary_1.DictionaryType.deleteMany({});
        await Dictionary_1.DictionaryItem.deleteMany({});
        await DeliveryTemplate_1.default.deleteMany({});
        // 创建字典类型
        const types = [
            {
        ...
        await Dictionary_1.DictionaryType.insertMany(types);
        ...
        await Dictionary_1.DictionaryItem.insertMany(categories);
        ...
        await Dictionary_1.DictionaryItem.insertMany(deliveryTypes);
        ...
        await DeliveryTemplate_1.default.insertMany(templates);
...
initDictionary();
//# sourceMappingURL=initDictionary.js.map